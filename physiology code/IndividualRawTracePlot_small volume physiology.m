% Code for saving individual trace--Breathing 10s
...
for i = 1:size(cp,2)
    ...
    %if ismember('VLM',trialinfo_extract{3,2}{i,3}) & ismember('E',trialinfo_extract{3,2}{i,4})
        ...
        fname =[num2str(ci{fix((i-1)/3)+1,1}),'-',ci{fix((i-1)/3)+1,2},'-',ci{fix((i-1)/3)+1,3},'-T',num2str(ti),'-idx',num2str(i),'-BreathingRawTrace-10s(0_2ms)'];
        ti=ti+1
...
%% Code for saving individual trace--ECG 10s
...
for i = 1:size(cp,2)
    ...
    %if ismember('VLM',trialinfo_extract{3,2}{i,3}) & ismember('E',trialinfo_extract{3,2}{i,4})
        ...
        fname =[num2str(ci{fix((i-1)/3)+1,1}),'-',ci{fix((i-1)/3)+1,2},'-',ci{fix((i-1)/3)+1,3},'-T',num2str(ti),'-idx',num2str(i),'-EKGRawTrace-10s(0_2ms)'];
        ti=ti+1
        title(fname, fontsize=12);
        saveas(gcf,strcat([fname,'.jpeg']))
        print(gcf,'-vector','-dsvg',[fname,'.svg']) % svg
...
for i = 1:size(cp,2)
    ...
    %if ismember('VLM',trialinfo_extract{3,2}{i,3}) & ismember('E',trialinfo_extract{3,2}{i,4})
        ...
        fname =[num2str(ci{fix((i-1)/3)+1,1}),'-',ci{fix((i-1)/3)+1,2},'-',ci{fix((i-1)/3)+1,3},'-T',num2str(ti),'-idx',num2str(i),'-BPRawTrace-1min(0_2ms)'];
        ti=ti+1
        title(fname, fontsize=12);
        saveas(gcf,strcat([fname,'.jpeg']))
        print(gcf,'-vector','-dsvg',[fname,'.svg']) % svg
...
%% Code for saving individual trace--GP 2min
[fileDir] = uigetdir( 'Output');
cd(fileDir)
xstart =-119.9998;
xend = 150;
...
for i = 1:size(cp,2)
    ...
    %if ismember('VLM',trialinfo_extract{3,2}{i,3}) & ismember('E',trialinfo_extract{3,2}{i,4})
        ...
        fname =[num2str(ci{fix((i-1)/3)+1,1}),'-',ci{fix((i-1)/3)+1,2},'-',ci{fix((i-1)/3)+1,3},'-T',num2str(ti),'-idx',num2str(i),'-GPRawTrace-2min(0_2ms)'];
        ti=ti+1;      
        title(fname, fontsize=12);
        saveas(gcf,strcat([fname,'.jpeg']))
        print(gcf,'-vector','-dsvg',[fname,'.svg']) % svg
...
%% Code for saving individual trace--Breathing 2min
[fileDir] = uigetdir( 'Output');
cd(fileDir)
xstart =-119.9998;
xend = 150;
...
for i = 1:size(cp,2)
    ...
    %if ismember('VLM',trialinfo_extract{3,2}{i,3}) & ismember('E',trialinfo_extract{3,2}{i,4})
        ...
        fname =[num2str(ci{fix((i-1)/3)+1,1}),'-',ci{fix((i-1)/3)+1,2},'-',ci{fix((i-1)/3)+1,3},'-T',num2str(ti),'-idx',num2str(i),'-BreathingRawTrace-2min(0_2ms)'];
        ti=ti+1;      
        title(fname, fontsize=12);
        saveas(gcf,strcat([fname,'.jpeg']))
        print(gcf,'-vector','-dsvg',[fname,'.svg']) % svg
